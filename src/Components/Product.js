  ...
  return (
    <div>
      <div className="relative flex justify-center">
        ...
        <img src={images.tablet} alt={name} className="rounded-lg w-full hidden md:block xl:hidden" />
        <img src={images.desktop} alt={name} className="rounded-lg w-full hidden xl:block" />

          <img src={images.mobile} alt={name} className="rounded-lg w-full md:hidden" />
        </div>
